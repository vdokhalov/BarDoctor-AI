...
export const PERMISSION_DEFINITIONS: PermissionDefinition[] = [
  ...
  { key: "sales.view", group: "Продажи", label: "Просмотр продаж", description: "Видеть SalesBatch и статус отражения продаж на складе." },
  { key: "sales.create", group: "Продажи", label: "Ввод продаж", description: "Создавать и редактировать черновики агрегированных продаж." },
  { key: "sales.post", group: "Продажи", label: "Проведение продаж", description: "Создавать складской расход по подтверждённым техкартам." },
  { key: "sales.reverse", group: "Продажи", label: "Сторно продаж", description: "Сторнировать проведённые продажи с сохранением истории." },
  { key: "sales.manage_mapping", group: "Продажи", label: "Сопоставления продаж", description: "Подтверждать и изменять соответствия внешних названий позициям меню." },
...
const PERMISSION_DEPENDENCIES: Partial<Record<PermissionKey, PermissionKey>> = {
  ...
  "sales.reverse": "sales.post",
  "sales.manage_mapping": "sales.view",
