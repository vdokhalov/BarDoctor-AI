...
export function canonicalUserShellAssets(): string {
  return `<script src="/venue-timezone.js?v=venue-time-v456"></script><script src="/accounting-currency.js?v=pos1-functional"></script><link rel="stylesheet" href="/app-shell-v185.css?v=${APP_SHELL_VERSION}" />
