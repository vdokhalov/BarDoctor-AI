...
const STORE_MODULES: Record<string, ModuleConfig> = {
  ...
  bd_sales_batches: { key: "sales", label: "Продажи", object: "SalesBatch", route: "/sales-import", viewPermission: "sales.view" },
  bd_sales_mappings: { key: "sales", label: "Продажи", object: "сопоставление названия", route: "/sales-import", viewPermission: "sales.view" },
  bd_sales_warehouse_routes: { key: "sales", label: "Продажи", object: "маршрут расхода", route: "/sales-import", viewPermission: "sales.view" },
