(async function () {
  ...
  var bdStartupRecoveryVersionV341 = "p0-release-blockers-v401";
  var bdStartupRecoveryContractV341 = "bounded-startup-v357";
  ...
  function bdRenderStartupRecoveryV341(reason, failureDetail) {
    ...
    var render = function () {
      ...
      var splash = document.querySelector('[data-bd-static-startup="v201"]');
      if (splash) splash.remove();
      root.innerHTML = "";
      var page = document.createElement("main");
      page.setAttribute("data-bd-startup-recovery", bdStartupRecoveryContractV341);
      page.setAttribute("role", "alert");
      page.style.cssText = "position:fixed;inset:0;z-index:2147483647;min-height:100dvh;display:grid;place-items:center;overflow:auto;box-sizing:border-box;padding:24px;background:#070911;color:#fff;font-family:Inter,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif";
  ...
  function loadApplication() {
    ...
    script.type = "module";
    script.src = "/assets/index-BQGspy0I.js?v=startup-performance-v343-shell-first-v397-p0-release-blockers-v401";
