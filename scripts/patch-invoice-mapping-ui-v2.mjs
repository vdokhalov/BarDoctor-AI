...
bootstrap = bootstrap.replace(/\?v=([^"']*?)-20260826-invoice-mapping-(?:shadow-v294|name-integrity-v296)/g, "?v=$1");
...
appHtml = appHtml.replace(/\?v=([^"']*?)-20260826-invoice-mapping-(?:shadow-v294|name-integrity-v296)/g, "?v=$1");
