...
test("warehouse write-offs use the canonical multi-item document workflow", async () => {
  ...
  assert.match(bundle, /function x\(\)\{bdWriteoffClosingV418\.current=!0,bdSetWriteoffSheetOpenV417\(!1\),a\(bdWarehouseNavigationUrlV247\(\{writeoff:null,tab:"writeoffs"\}\),\{replace:!0\}\)\}/);
